...
function ThankYouPage() {
    ...
    return (
        ...
        <div className={classes.root}  align="center" justifyContent="center">
            <Typography variant="h4" className={classes.thanks}>Thank you!</Typography >
            ...
            <Typography className={classes.link}>Aap humein{" "}
            <Link href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=hi@navgurukul.org">
                hi@navgurukul.org
            </Link> par mail bhi kar sakte hai.</Typography>
            <Button
              type="submit"
              fullWidth
              variant="contained"
