...
const tutorialSteps = {
    ...
    content2: "(out of 18 questions) Aapne 0 questions already attempt kar liye hai!",
        ...
        <Container maxWidth="lg" align="center" justifyContent="center">
            <div className={classes.root}>
                ...
                </Paper>  */}
                {
                    ...
                    questionsList[index].options.map((option, i) => (
                            <Paper square elevation={0} className={classes.content}>
                                <Typography variant="h7" key='i'>{i+1}{"."}{" "}{option.text}</Typography>
                            </Paper> 
                        )
                    ) : null
                }
